        ...
        <div class="carousel-wrapper">
          ...
          <div class="carousel-container">
            <div class="carousel maps-carousel">
              <div class="carousel-item">
                <img src="/images/Valorant/icons8-valorant-480.webp" alt="Map Image"/>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="main-content">
        <section class="line">
          <div class="card" @click="selectMap('Abyss')">
            <img src="/images/Valorant/Map/Loading_Abyss.webp"  alt="Illustration personnage" />
            <div class="card-content">
              <h1 class="card-title">Abyss</h1>
            </div>
          </div>
          <div class="card" @click="selectMap('Ascent')">
            <img src="/images/Valorant/Map/Loading_Ascent.webp"  alt="Illustration personnage" />
            <div class="card-content">
              <h1 class="card-title">Ascent</h1>
            </div>
          </div>
          <div class="card" @click="selectMap('Bind')">
            <img src="/images/Valorant/Map/Loading_Bind.webp"  alt="Illustration personnage" />
            <div class="card-content">
              <h1 class="card-title">Bind</h1>
            </div>
          </div>
          <div class="card" @click="selectMap('Breeze')">
            <img src="/images/Valorant/Map/Loading_Breeze.webp"  alt="Illustration personnage" />
            <div class="card-content">
        ...
        <section class="line">
          <div class="card" @click="selectMap('Fracture')">
            <img src="/images/Valorant/Map/Loading_Fracture.webp"  alt="Illustration personnage" />
            <div class="card-content">
          ...
          <div class="card" @click="selectMap('Haven')">
            <img src="/images/Valorant/Map/Loading_Haven.webp"  alt="Illustration personnage" />
            <div class="card-content">
              <h1 class="card-title">Haven</h1>
            </div>
          </div>
          <div class="card" @click="selectMap('Icebox')">
            <img src="/images/Valorant/Map/Loading_Icebox.webp"  alt="Illustration personnage" />
            <div class="card-content">
        ...
        <section class="line">
          <div class="card" @click="selectMap('Lotus')">
            <img src="/images/Valorant/Map/Loading_Lotus.webp"  alt="Illustration personnage" />
            <div class="card-content">
              <h1 class="card-title">Lotus</h1>
            </div>
          </div>
          <div class="card" @click="selectMap('Pearl')">
            <img src="/images/Valorant/Map/Loading_Pearl.webp"  alt="Illustration personnage" />
            <div class="card-content">
              <h1 class="card-title">Pearl</h1>
            </div>
          </div>
          <div class="card" @click="selectMap('Split')">
            <img src="/images/Valorant/Map/Loading_Split.webp"  alt="Illustration personnage" />
            <div class="card-content">
              <h1 class="card-title">Split</h1>
            </div>
          </div>
          <div class="card" @click="selectMap('Sunset')">
            <img src="/images/Valorant/Map/Loading_Sunset.webp"  alt="Illustration personnage" />
            <div class="card-content">
