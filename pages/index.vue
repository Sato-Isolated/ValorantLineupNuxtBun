    ...
    <header class="header">
      <div class="header-body">
        <div class="header-content">
          <img @click="goToHomePage" src="/images/Logo.webp" alt="Logo de La Brousse" width="96" height="96" />
    ...
    <main class="main-body">
      <div class="main-content">
        ...
        <section class="halo-sphere">
          <img src="/images/icegif-664.webp" alt="Gif représentant Valorant" width="400" height="400" />
        </section>
      </div>
    </main>
...
const originalAgents = [
  "/images/Agent/Astra_icon.webp",
  "/images/Agent/Breach_icon.webp",
  "/images/Agent/Brimstone_icon.webp",
  "/images/Agent/Chamber_icon.webp",
  "/images/Agent/Clove_icon.webp",
  "/images/Agent/Cypher_icon.webp",
  "/images/Agent/Harbor_icon.webp",
  "/images/Agent/Deadlock_icon.webp",
  "/images/Agent/Fade_icon.webp",
  "/images/Agent/Iso_icon.webp",
  "/images/Agent/Neon_icon.webp",
  "/images/Agent/Gekko_icon.webp",
  "/images/Agent/Omen_icon.webp",
  "/images/Agent/Sage_icon.webp",
  "/images/Agent/Sova_icon.webp",
  "/images/Agent/Viper_icon.webp",
  "/images/Agent/Yoru_icon.webp",
  "/images/Agent/Jett_icon.webp",
  "/images/Agent/KAYO_icon.webp",
  "/images/Agent/Killjoy_icon.webp",
  "/images/Agent/Phoenix_icon.webp",
  "/images/Agent/Raze_icon.webp",
  "/images/Agent/Reyna_icon.webp",
  "/images/Agent/Skye_icon.webp",
];
const originalMaps = [
  "/images/Map/Loading_Abyss.webp",
  "/images/Map/Loading_Ascent.webp",
  "/images/Map/Loading_Bind.webp",
  "/images/Map/Loading_Breeze.webp",
  "/images/Map/Loading_Fracture.webp",
  "/images/Map/Loading_Haven.webp",
  "/images/Map/Loading_Icebox.webp",
  "/images/Map/Loading_Lotus.webp",
  "/images/Map/Loading_Pearl.webp",
  "/images/Map/Loading_Split.webp",
  "/images/Map/Loading_Sunset.webp",
];
